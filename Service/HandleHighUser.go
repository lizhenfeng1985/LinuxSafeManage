...
func HighUserGroupAddHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		err := DBHighUserGroupAdd(GHandleDBRuleUser, req.Group)
		if err != nil {
...
func HighUserGroupDelHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		err := DBHighUserGroupDel(GHandleDBRuleUser, req.Group)
		if err != nil {
			w.Write(HighUserErrResponse(&res, -1, err.Error()))
			return
		}
...
func HighUserGroupSearchHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		res.Groups, err = DBHighUserGroupSearch(GHandleDBRuleUser)
		if err != nil {
...
func HighUserAddHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		err := DBHighUserAdd(GHandleDBRuleUser, req.Group, req.User)
		if err != nil {
			w.Write(HighUserErrResponse(&res, -1, err.Error()))
			return
		}
...
func HighUserDelHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		err := DBHighUserDel(GHandleDBRuleUser, req.User)
		if err != nil {
			w.Write(HighUserErrResponse(&res, -1, err.Error()))
			return
		}
...
func HighUserSearchHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		// logic
		res.Users, res.Total, err = DBHighUserSearch(GHandleDBRuleUser, req.Group, req.Start, req.Length)
		if err != nil {
